...
function _0x54cf() {
  var _0x3b099b = ['//01234.fun/#/?url=', '#clickclapper', '#clickjw', '#clickkaltura', 'ready', 'click', 'player/plyr.html?sv=', '3405XrSkFx', '321213yYBNCx', '//raw.githack.com/tvbd/m3u/main/player/index.html?sv=', 'val', 'filter', 'href', '7915257ZqdtrX', '.col-sm-4', '3427216GLOOzU', 'toggle', '#clicknetflix', '#search', '#link', '3337271ldYQHU', 'text', 'toLowerCase', 'location', 'indexOf', '2524176ixXQfA', '186616phrAOC', '8FYnOsT', 'player/m3u.html?sv=', 'player/vjs.html?sv=', '2756mbGhPN'];
  _0x54cf = function () {
    return _0x3b099b;
  };
  return _0x54cf();
