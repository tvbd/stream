...
function _0x54cf() {
  var _0x3b099b = ['player/jwnetflix.html?sv=', '#clickclapper', '#clickjw', '#clickvjs', '#clickjs', '#clickm3u', '#clicm3u2', '#clickoven', '#clickkaltura', 'ready', 'click', 'player/plyr.html?sv=', '3405XrSkFx', '321213yYBNCx', 'player/clapper.html?sv=', 'val', 'filter', 'href', '7915257ZqdtrX', '.col-sm-4', '3427216GLOOzU', 'toggle', '#clicknetflix', '#search', '#link', '3337271ldYQHU', 'text', 'toLowerCase', 'location', 'indexOf', '2524176ixXQfA', '186616phrAOC', '8FYnOsT', 'player/kaltura.html?sv=', 'player/jwplayer.html?sv=', 'player/oven.html?sv=', 'player/vjs.html?sv=', 'player/js.html?sv=', 'player/m3u.html?sv=', '//01234.fun/#/?url=', '2756mbGhPN'];
  _0x54cf = function () {
    return _0x3b099b;
  };
  return _0x54cf();
...
$(document).ready(function () {
  ...
  $("#clicknetflix").click(function () {
    window.location.href = "player/jwnetflix.html?sv=" + $("#link").val();
  });
 $("#clickoven").click(function () {
    window.location.href = "player/oven.html?sv=" + $('#link').val();
  });

 $("#clickvjs").click(function () {
    window.location.href = "player/vjs.html?sv=" + $('#link').val();
  });

   $("#clickjs").click(function () {
    window.location.href = "player/playerjs.html?sv=" + $('#link').val();
  });

     $("#clickm3u").click(function () {
    window.location.href = "player/m3u.html?sv=" + $('#link').val();
  });

   $("#clickm3u2").click(function () {
